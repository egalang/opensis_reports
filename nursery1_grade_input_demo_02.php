...
<head>
	...
	<script type="text/javascript" language="javascript" src="../../../css/dataTables.buttons.min.js"></script>
	<script type="text/javascript" language="javascript" src="../../../css/dataTables.select.min.js"></script>
	...
	if ($students_result->num_rows > 0){
		while($students_row = $students_result->fetch_assoc()){
			...
			$sql = "INSERT INTO character_building_nursery1 (school_id,marking_period_id,section_id,student_id) values (1,$marking_period_id,$section_id,$student_id)";
