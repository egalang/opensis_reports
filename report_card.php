        ...
        <tr>
                <td style="width:49%; vertical-align:top">
                        <table class="table table-bordered table-condensed" style="font-size:80%">
                                ...
                                ?>
                                <tr>
                                        <td style='height:70px'>First Grading:<br><i><?php echo $row_comment_01['comment'] ?></i></td>
                                </tr>
								<?php
                                        $sql = "SELECT student_id, marking_period_id, comment 
										FROM `student_mp_comments` 
                                ...
                                ?>
                                <tr>
                                        <td style='height:70px'>Second Grading:<br><i><?php echo $row_comment_02['comment'] ?></i></td>
                                </tr>
								<?php
                                        $sql = "SELECT student_id, marking_period_id, comment 
										FROM `student_mp_comments` 
                                ...
                                <tr>
                                <tr>
                                        <td style='height:70px'>Third Grading:<br><i><?php echo $row_comment_03['comment'] ?></i></td>
                                </tr>
								<?php
                                        $sql = "SELECT student_id, marking_period_id, comment 
										FROM `student_mp_comments` 
                                ...
                                ?>
                                <tr>
                                        <td style='height:70px'>Fourth Grading<br><i><?php echo $row_comment_04['comment'] ?></i></td>
                                </tr>
                        </table>
                        <table class="table table-bordered table-condensed" style="font-size:80%">
                                <tr>
                        ...
                        <table class="table table-bordered table-condensed" style="font-size:80%">
                                ...
                                <?php
                                        $sql = "select TIMESTAMPDIFF(YEAR, students.birthdate, CURDATE()) AS age, students.student_id,
                                                        ...
                                                        school_gradelevels.title, school_gradelevel_sections.name, student_enrollment.syear,
														student_enrollment.school_id
                                                        from students
										...
										$syear = $row['syear']; $school_id = $row['school_id'];
                                ?>
                                ...
                                <tr><td colspan='2' width='50%'><center>EVANGELINE P. DIZON, Ed.D.</center></td><td colspan='2'><center><?php echo strtoupper($row_log['first_name'] . SUBSTR($row_log['middle_name'], 0, 1) . ". " . $row_log['last_name']) ?></center></td></tr>
        ...
        <tr>
                ...
                <td style="vertical-align:top">
                        <table class="table table-bordered table-condensed" style="font-size:80%">
                                ...
                                <?php
									$marking_period_id = 15;
									
									while($marking_period_id <= 18) {
										$value_id = 1;
										 
										while($value_id <= 7) {
											$sql = "INSERT INTO character_building (syear, school_id, marking_period_id, student_id, value_id, value) 
													VALUES ($syear, $school_id, $marking_period_id, $student_id, $value_id, '');";
