...
*/
echo "<td align=center width='50'><b>QG</b></td><td align=center width='50'><b>W&SH</b></td><td align=center width='50'><b>SS</b></td><td align=center width='50'><b>MS</b></td><td align=center width='50'><b>SpS</b></td><td width='250' align=center><b>Comments</b></td></tr>";
...
if ($students_result->num_rows > 0){
	while($students_row = $students_result->fetch_assoc()){
		...
		echo "<tr><td><a href='report_card_ps_demo_01.php?student=".$student_id."'>".$students_row['last_name'].", ".$students_row['first_name']."</a></td>";
		...
		echo "<td>".$ga."</td><td>";
		//get averages start
		$ave_sql = "SELECT * FROM character_building_preschool where student_id = $student_id and marking_period_id = $marking_period_id and section_id = $section_id and school_id = $school_id";
		$ave_result = $conn->query($ave_sql);
		$ave_row = $ave_result->fetch_assoc();
		$wash_ave = ( $ave_row['wash_1'] + $ave_row['wash_2'] + $ave_row['wash_3'] + $ave_row['wash_4'] ) / 4;
		$ss_ave = ( $ave_row['ss_1'] + $ave_row['ss_2'] + $ave_row['ss_3'] + $ave_row['ss_4'] + $ave_row['ss_5'] ) / 5;
		$ms_ave = ( $ave_row['ms_1'] + $ave_row['ms_2'] + $ave_row['ms_3'] + $ave_row['ms_4'] + $ave_row['ms_5'] + $ave_row['ms_6'] + $ave_row['ms_7'] + $ave_row['ms_8'] ) / 8;
		$sp_ave = ( $ave_row['sp_1'] + $ave_row['sp_2'] + $ave_row['sp_3'] + $ave_row['sp_4'] ) / 4;
		//get averages end
		echo letter_grade($wash_ave)."</td><td>".letter_grade($ss_ave)."</td><td>".letter_grade($ms_ave)."</td><td>".letter_grade($sp_ave)."</td><td style='font-size:80%'>".$comments_row['comment']."</td></tr>";
